...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Bhaiyaa") || (event.body.toLowerCase() == "vaijan") || (event.body.toLowerCase() == "@Manaf ッ") || (event.body.toLowerCase() == "মানাফ")) {
   ...
   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:MANAF SIKDER ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস মানাফ আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is MANAF SIKDER ッ❤️ তাকে সবাই মানাফ নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Fahima") || (event.body.toLowerCase() == "prema")) {
  ...
  if ((event.body.toLowerCase() == "Arohi") || (event.body.toLowerCase() == "tahmina")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস মানাফ এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "@Shahadat SA HU ") || (event.body.toLowerCase() == "সাহু")) {
     return api.sendMessage("🥰-সাহু-🌺 আমার বস মানাফ'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
